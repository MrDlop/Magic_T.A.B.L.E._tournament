...
//            player1.setStandart_card_world_rotation(180);
//            players[1] = player1;
//        }
//        if (players_count == 3) {
//            Player player = new Player(new Vector3(0, 50, 40), 0);
...
//            player.trash_pos = new Vector3(18, 29.7f, 28);
//            player.played_card_pos = new Vector3(0, 30, 25);
//            player.setStandart_card_world_rotation(0);
//            players[0] = player;
...
//            player1.setStandart_card_world_rotation(-90);
//            players[1] = player1;
...
//            player2.setStandart_card_world_rotation(180);
//            players[2] = player2;
//
//        }
//        if (players_count == 4) {
...
//            player3.setStandart_card_world_rotation(-270);
//            players[3] = player3;
//        }
...
//                card.instance.transform.rotate(0, card.getHitBox().getCenterY(), 0, players[i].getStandart_card_world_rotation());
